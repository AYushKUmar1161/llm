...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'text-slate-300 hover:bg-white/5 hover:text-slate-100 data-[state=open]:bg-white/5',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-xl glass-strong border border-white/10 p-1.5',
      'shadow-glass text-slate-300',
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[10rem] overflow-hidden rounded-xl glass-strong border border-white/10 p-1.5',
        'shadow-glass text-slate-300',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
        'data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      ...
      'text-slate-300 hover:bg-white/5 hover:text-slate-100 focus:bg-white/5 focus:text-slate-100',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-1.5 h-px bg-white/[0.06]', className)}
    {...props}
  />
))
